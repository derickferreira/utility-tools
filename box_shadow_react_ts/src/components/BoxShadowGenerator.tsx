...
const BoxShadowGenerator = () => {
  ...
  return (
    <>
      <div id="box_shadow_generator" className="p-6 bg-white rounded-lg flex">
        <div id="controls_container" className="space-y-4">
          ...
          <div className="form_control">
            <div className="range_input">
              ...
              <input
                onChange={(event) =>
                  setHorizontal(parseInt(event.target.value))
                }
                value={horizontal}
                type="range"
                name="horizontal"
          ...
          <div className="form_control">
            <div className="range_input">
              ...
              <input
                onChange={(event) => setColourBox(event.target.value)}
                value={colourBox}
                type="color"
                name="boxColour"
                id="boxColour"
        ...
        <div id="preview" className="flex flex-col items-center">
          ...
          <div
            ...
            style={{ boxShadow, backgroundColor: colourBox }}
          ></div>
        </div>
      </div>
      <div
      ...
      >
        <h2 className="text-xl">CSS Rules</h2>
